...
class PredictionsTabScreen extends StatefulWidget {
  ...
  @override
  State<PredictionsTabScreen> createState() =>
      _PredictionsTabScreenState();
}

class _PredictionsTabScreenState
    extends State<PredictionsTabScreen> {
  @override
  ...
  String _getMockOtherPredictions(
      String matchId) {
    Map<String, String> mockData = {
      "1":
      "60% say Manchester United wins",
      "2": "55% say Draw",
      "3":
      "70% say Australia wins",
    };
    return mockData[matchId] ??
        "No data yet";
  }
}
